process PRSice_calculate_PRS_split_partitions {
    ...
    tuple val(cohort), path (HCM_GWAS),  val(ENH_list), \
    ...
    output:
    tuple val("${ENH_list}"), path("*_clumped_TS_ENH_GWAS_compartment_*.summary"), path("*_clumped_TS_ENH_GWAS_compartment_*.prsice"), path("*_clumped_TS_ENH_GWAS_compartment_*.best"),          emit: clumped_TS_ENH_GWAS_compartment_PRS
    tuple val("${ENH_list}"), path("*_clumped_residual_GWAS_compartment.summary"), path("*_clumped_residual_GWAS_compartment.prsice"), path("*_clumped_residual_GWAS_compartment.best"),          emit: clumped_residual_GWAS_compartment_PRS
    tuple val("${ENH_list}"), path("*_clumped_merged_GWAS.summary"), path("*_clumped_merged_GWAS.prsice"), path("*_clumped_merged_GWAS.best"),  path(cohort_fam_QC),                              emit: clumped_merged_GWAS_PRS
    tuple val("${ENH_list}"), path("*_original_HCM_GWAS.summary"), path("*_original_HCM_GWAS.prsice"), path("*_original_HCM_GWAS.best"),                                                          emit: clumped_original_HCM_GWAS_PRS
