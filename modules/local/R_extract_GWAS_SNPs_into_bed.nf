process R_extract_GWAS_SNPs_into_bed {
    ...
    tuple path(GWAS_QC_nodups), path(GWAS_QC_nodups_clumped_SNPs)
    ...
    R_extract_GWAS_SNPs_into_bed.R ${GWAS_QC_nodups} collected_bed_files_for_enhancers.txt ${GWAS_QC_nodups_clumped_SNPs}
